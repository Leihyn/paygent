// Unified demo app (Express instance, no listen()).
...
//   src/demo/server.ts  -> `npm start` (local, app.listen)
//   api/index.ts        -> Vercel serverless function (app exported as handler)
